...
(function() {
  var BrowserDetect, Connection, GUI, GUI_OIIO, Output, addTab, add_alert, closeTab, exports, getParentTextOnly, getType, get_appropriate_ws_url, lib, loadLibrary, makeNewName, onTabKey, pos, removeFromArray, removeLastChunk, setupLibraryEditor, setupSocket, socket, transferTab,
  ...
  addTab = function(type) {
    ...
    li.find("a").attr("data-name", label).text(label).attr("href", "#" + id).resize(function() {
      return console.log($(this).innerWidth());
    });
    ...
    if (type === "Library") {
      ...
      return console.log("GUI");
    } else if (type === "Output") {
      if (exports.output == null) {
        return exports.output = new Output(tabContentHtml);
      }
    } else if (type === "OIIO") {
      return console.log("OIIO");
    }
  };
  ...
  Output = (function() {
    ...
    Output.prototype.init = function() {
      ...
      this.renderer.setSize(this.parentJ.innerWidth(), this.parentJ.innerHeight());
      this.parentJ.append(this.renderer.domElement);
      this.camera = new THREE.PerspectiveCamera(70, this.parentJ.innerWidth() / this.parentJ.innerHeight(), 1, 1000);
    ...
    Output.prototype.onWindowResize = function() {
      this.camera.aspect = window.innerWidth / window.innerHeight;
      this.camera.updateProjectionMatrix();
      return this.renderer.setSize(window.innerWidth, window.innerHeight);
    };

    Output.prototype.animate = function() {
